...
public class AzureFunctionsDemo
{
    private readonly ILogger<AzureFunctionsDemo> _logger;

    public AzureFunctionsDemo(ILogger<AzureFunctionsDemo> logger)
    {
        _logger = logger;
    }

    [Function("AzureFunctionsDemo")]
